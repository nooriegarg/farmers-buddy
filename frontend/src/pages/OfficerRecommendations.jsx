...
function OfficerRecommendations() {
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-200 text-sm mt-1">
              Look up personalized crop suggestions to advise farmers.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
            <div className="flex items-center gap-3 mb-5">
              <div className="bg-blue-100 p-2.5 rounded-xl">
                <FaSearch className="text-blue-700 text-lg" />
              </div>
              <div>
                <h2 className="text-lg font-bold text-gray-800">Smart Crop Selector</h2>
                <p className="text-gray-400 text-xs">Select region, season, and soil type to get suggestions</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSuggest} className="flex flex-wrap gap-3 items-end">
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded-xl font-bold text-white text-sm transition shadow-md ${
                  loading ? "bg-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-blue-700 to-blue-600 hover:from-blue-800"
                }`}
              >
            ...
            {suggestions.length > 0 && (
              <div className="mt-5 space-y-3">
                ...
                {suggestions.map((s, idx) => (
                  <div key={idx} className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-4">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      <span className="font-extrabold text-blue-800 text-base">{s.cropName}</span>
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <div className="border-t border-gray-100 pt-3">
                      <p className="text-xs text-gray-500 leading-relaxed">
                        <span className="font-semibold text-blue-700">Tip: </span>{item.tip}
                      </p>
                    </div>
                  </div>
                </div>
