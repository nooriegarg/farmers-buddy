        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-200 text-sm mt-1">
              Publish government schemes, farming tips, and important alerts for farmers.
            </p>
          </div>
        </div>
              ...
              <form onSubmit={handleCreate} className="mt-4 bg-white rounded-2xl shadow-md border border-gray-100 p-6 space-y-4 max-w-2xl">
                ...
                <div className="flex gap-3">
                  <select
                    ...
                    className="border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
                  >
...
export default OfficerAwareness
